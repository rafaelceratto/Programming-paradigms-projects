error id: file://<HOME>/Documentos/0Paradigmas%20de%20p./Recuperatorios/Lab2/parcial2-skeleton/parcial2/src/main/scala/NamedEntity.scala:scala/util/matching/Regex#findFirstIn().
...
empty definition using pc, found symbol in pc: scala/util/matching/Regex#findFirstIn().
...
non-local guesses:
	 ...
	 -pattern/findFirstIn#
	 -pattern/findFirstIn().
	 -scala/Predef.pattern.findFirstIn.
	 -scala/Predef.pattern.findFirstIn#
	 -scala/Predef.pattern.findFirstIn().
offset: 729
...
abstract class NamedEntity(val text: String) {
  ...
  def matches(input: String): Boolean = {
    ...
    pattern.find@@FirstIn(input).isDefined
  }
